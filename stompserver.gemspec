...
Gem::Specification.new do |s|
  ...
  s.version = "0.9.10.20101122"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Lionel Bouton", "kates"]
  s.date = %q{2010-11-22}
...
Handles basic message queue processing}
  ...
  s.homepage = %q{http://stompserver.rubyforge.org/}
  s.rdoc_options = ["--main", "README.txt"]
  s.require_paths = ["lib"]
  s.rubyforge_project = %q{stompserver}
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{A very light messaging server}
  s.test_files = ["test/test_queue_manager.rb", "test/test_stomp_frame.rb", "test/test_topic_manager.rb"]
